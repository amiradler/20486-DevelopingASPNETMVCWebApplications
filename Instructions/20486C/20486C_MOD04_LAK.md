...
```
9. On the toolbar of the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Save Views\Photo\Index.cshtml (Ctrl+S)**.
10. On the **FILE** menu of the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Close**.
...
14. In the **Template** box, ensure that **Details** is selected.
15. In the **Model class** box, ensure that the **Photo (PhotoSharingApplication.Models)** model class is selected.
16. In the **Add View** dialog box, ensure that the **Reference script libraries** and the **Use a layout** check boxes are selected, and then click **Add**.
...
7. On the **FILE** menu of the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Close**.
